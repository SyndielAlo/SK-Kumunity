...
$email=$_POST['emailid'];
$query=mysqli_query($dbh,"Update  tbladmin set AdminEmailId='$email'  where userType=0 && id='$aid'");
if($query)
{
...
<?php 
$aid=intval($_GET['said']);
$query=mysqli_query($dbh,"Select * from  tbladmin where userType=0 && id='$aid'");
$cnt=1;
