...
$ev=$query->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($ev);?></div>
													<div class="stat-panel-title text-uppercase">Total Problems</div>
												</div>
											</div>
											<a href="problemlist.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
<?php
$reciver = 'Admin';
$sql12 ="SELECT id_notif from notification where notireciver = (:reciver)";
