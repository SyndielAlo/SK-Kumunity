...
$sql=mysqli_query($dbh,"SELECT AdminPassword FROM  tbladmin where AdminUserName='$adminid' || AdminEmailId='$adminid'");
...
if (password_verify($password, $dbpassword)) {
 ...
 $dbh=mysqli_query($dbh,"update tbladmin set AdminPassword='$newhashedpass', updationDate='$currentTime' where AdminUserName='$adminid'");
