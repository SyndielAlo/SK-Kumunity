...
if( $_GET['disid'])
{
	...
	$query=mysqli_query($dbh,"update tblcomments set status='0' where id='$id'");
...
if($_GET['appid'])
{
	...
	$query=mysqli_query($dbh,"update tblcomments set status='1' where id='$id'");
...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($dbh,"delete from  tblcomments  where id='$id'");
											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($dbh,"Select tblcomments.id,  tblcomments.name,tblcomments.email,tblcomments.postingDate,tblcomments.comment,tblposts.id as postid,tblposts.PostTitle from  tblcomments join tblposts on tblposts.id=tblcomments.postId where tblcomments.status=1");
$cnt=1;
