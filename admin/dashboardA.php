        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="announcements.php" class="logo"><span>NP<span>Admin</span></span><i class="mdi mdi-layers"></i></a>
                    <!-- Image logo -->
...
<?php $query=mysqli_query($dbh,"select * from tblcategory where Is_Active=1");
...
<?php $query=mysqli_query($dbh,"select * from tblsubcategory where Is_Active=1");
...
<?php $query=mysqli_query($dbh,"select * from tblposts where Is_Active=1");
...
<?php $query=mysqli_query($dbh,"select * from tblposts where Is_Active=0");
$countposts=mysqli_num_rows($query);
?>
                                        <h2><?php echo htmlentities($countposts);?> <small></small></h2>
