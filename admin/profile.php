...
if(isset($_POST['submit']))
  {	
	...
	$email=$_POST['email'];
  $idedit=$_POST['editid'];
	$sql="UPDATE admin SET username=(:name), email=(:email) WHERE id=(:idedit)";
...
<div class="col-sm-4">
<input type="email" name="email" class="form-control" required value="<?php echo htmlentities($result->AdminEmail);?>">
</div>
</div>
