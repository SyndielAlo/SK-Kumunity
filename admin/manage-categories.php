...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($dbh,"update tblcategory set Is_Active='0' where id='$id'");
...
if($_GET['resid'])
{
	...
	$query=mysqli_query($dbh,"update tblcategory set Is_Active='1' where id='$id'");
...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($dbh,"delete from  tblcategory  where id='$id'");
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($dbh,"Select id,CategoryName,Description,PostingDate,UpdationDate from  tblcategory where Is_Active=1");
$cnt=1;
