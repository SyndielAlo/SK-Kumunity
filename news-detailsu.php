...
if (empty($_SESSION['alogin'])) {
 $_SESSION['alogin'] = bin2hex(random_bytes(32));
}
...
if (!empty($_POST['csrftoken'])) {
    if (hash_equals($_SESSION['alogin'], $_POST['csrftoken'])) {
$name=$_POST['name'];
$email=$_POST['email'];
...
<a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $currenturl;?>" target="_blank">Linkedin</a>  <b>Visits:</b> <?php print $visits; ?>
 ...
 <img class="img-fluid rounded" src="user/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
...
<div class="card my-4">
      ...
      <input type="hidden" name="csrftoken" value="<?php echo htmlentities($_SESSION['alogin']); ?>" />
